...
//import org.apache.http.HttpStatus; // this is for the priorly used.
...
public class DemoTest {
    ...
    public void makeSureItWorks(){
        final String urlTest = "http://services.groupkt.com/state/get/USA/all";

        RestTemplate restTemplate = new RestTemplate();
        String result = restTemplate.getForObject(urlTest,String.class, SC_OK);
